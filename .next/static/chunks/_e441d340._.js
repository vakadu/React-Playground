...
"[project]/src/app/auto-complete/api.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/auto-complete/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$auto$2d$complete$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/auto-complete/api.js [app-client] (ecmascript)");
;
...
function AUtoComplete() {
    ...
    const handleSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$28$2e$3_$40$playwright$2b$test$40$1$2e$54$2e$2_react$2d$dom$40$19$2e$1$2e$1_react$40$19$2e$1$2e$1_$5f$react$40$19$2e$1$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(debounce({
        "AUtoComplete.useCallback[handleSearch]": (searchTerm)=>{
            setData({
                "AUtoComplete.useCallback[handleSearch]": (prev)=>prev === null || prev === void 0 ? void 0 : prev.filter({
                        "AUtoComplete.useCallback[handleSearch]": (item)=>item === null || item === void 0 ? void 0 : item.id.includes(searchTerm)
                    }["AUtoComplete.useCallback[handleSearch]"])
            }["AUtoComplete.useCallback[handleSearch]"]);
        }
    }["AUtoComplete.useCallback[handleSearch]"]), []);
    async function fetchData() {
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$auto$2d$complete$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])();
        setData(response);
    }
    ...
    function handleKeyDown(e) {
        if (e.code === "Escape") {
            ...
            setActiveIndex((prev)=>prev < (data === null || data === void 0 ? void 0 : data.length) - 1 ? prev + 1 : (data === null || data === void 0 ? void 0 : data.length) - 1);
...
_s(AUtoComplete, "ZXx6OeWic2eeadDjKl7GOAqwlyY=");
_c = AUtoComplete;
var _c;
...
//# sourceMappingURL=_e441d340._.js.map